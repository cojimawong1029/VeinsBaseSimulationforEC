...
#ifndef SRC_VEINS_MODULES_EDGECOMPUTING_CarApplGameC_H_
#define SRC_VEINS_MODULES_EDGECOMPUTING_CarApplGameC_H_
...
class CarApplGameC : public BaseWaveApplLayer {
    public:
...
#endif /* SRC_VEINS_MODULES_EDGECOMPUTING_CarApplGameC_H_ */
