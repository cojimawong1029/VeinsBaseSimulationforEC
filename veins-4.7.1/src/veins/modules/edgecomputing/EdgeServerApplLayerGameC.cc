#include "veins/modules/edgecomputing/EdgeServerApplLayerGameC.h"
#include "veins/modules/edgecomputing/EdgeMessage/TaskRequest_m.h"


Define_Module(EdgeServerApplLayerGameC);

void EdgeServerApplLayerGameC::onWSA(WaveServiceAdvertisment* wsa) {
...
void EdgeServerApplLayerGameC::onWSM(WaveShortMessage* wsm) {
...
void EdgeServerApplLayerGameC::initialize(int stage) {
...
void  EdgeServerApplLayerGameC::receiveSignal(cComponent *source, simsignal_t signalID, double d, cObject *details){
...
void EdgeServerApplLayerGameC::handleTaskAck(cMessage* msg) {
...
void EdgeServerApplLayerGameC::handleSelfMsg(cMessage* msg) {
    if (msg == pingMsg) {
        WaveShortMessage* wsm = new WaveShortMessage();
        populateWSM(wsm);
        ...
        wsm->setRiE(dso->calUnitRate(geneRate, 0.1/2, 1000.0/110,betaj , gamaj, uj/numr,0.0));
...
void EdgeServerApplLayerGameC::handleMessage(cMessage* msg) {
